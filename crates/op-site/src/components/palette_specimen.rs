...
const TOKENS: &[(&str, &str, Role)] = &[
    ...
    ("--op-series-1", "chart series 1: orange", Role::Ui),
    ("--op-series-2", "chart series 2: bluish green", Role::Ui),
    ("--op-series-3", "chart series 3: blue", Role::Ui),
    ("--op-series-4", "chart series 4: reddish purple", Role::Ui),
    ("--op-series-5", "chart series 5: sky blue", Role::Ui),
    ("--op-series-6", "chart series 6: olive", Role::Ui),
    ("--op-playhead", "chart playhead", Role::Ui),
    ("--op-peek", "chart peek rule", Role::Ui),
    ("--op-band", "chart chapter band", Role::Backdrop),
